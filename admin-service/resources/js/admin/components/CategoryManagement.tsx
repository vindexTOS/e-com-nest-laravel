...
import { CategoryInput } from '../../graphql/categories';
...
const CategoryManagement: React.FC = () => {
    ...
    const categoriesQuery = useQuery<Category[]>({
        queryKey: ['categories', 'management', filters],
        queryFn: async () => {
    ...
    const deleteCategory = useMutation({
        ...
        onError: (error: any) => message.error(error.response?.data?.message || 'Failed to delete category'),
    });
    ...
    const restoreCategory = useMutation({
        ...
        onError: () => message.error('Failed to restore category'),
    });
